      ...
      // ----------------------------------------------------------------------
      {
        ...
        items: [
...

          {
            ...
            icon: ICONS.user,
            children: [{ title: 'list', path: paths.dashboard.leave.list }],
          },

          {
            ...
            icon: ICONS.user,
            children: [{ title: 'list', path: paths.dashboard.education.list }],
          },

          {
            ...
            children: [{ title: 'list', path: paths.dashboard.asset.list }],
          },
        ],
      },
    ],
