...
export const LEAVE_REASON_OPTIONS = [
 // { value: 'Selected Leave',  label: 'Selected Leave' },
...
export const _leaveList = [...Array(20)].map((_, index) => ({
    id: _mock.id(index),
    employeeName: _mock.fullName(index),
    employeeId: _mock.id(index),
    fromDate: '2023-08-01', // Replace with the desired fromDate
    reason: 'Vacation', // Replace with the desired reason
    toDate: '2023-08-05', // Replace with the desired toDate
    numberOfDays: '5', // Replace with the desired numberOfDays
