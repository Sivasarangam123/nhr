...
export default function LeaveTableRow({
  ...
  const { user, reason, status, numberOfDays } = row;
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{numberOfDays}</TableCell>
      ...
      <LeaveQuickEditForm currentLeave={row} open={quickEdit.value} onClose={quickEdit.onFalse} />
